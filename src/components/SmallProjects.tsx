    ...
    <div className="flex justify-center mx-[5vw] mt-16">
      <div className="w-full max-w-[1100px]">
        ...
        <p className="mt-4 mb-10 text-gray-400 text-xl text-center">
          ...
          checkout <a className=" underline underline-offset-4 text-gray-100 transition-all duration-200 ease-in  hover:no-underline hover:text-2xl "  href="github.com/ayusmann">Github</a> to see more of my projects
        </p>
