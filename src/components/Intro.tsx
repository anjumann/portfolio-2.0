...
const Intro: FC = () => {
  return (
    <div className="relative h-screen flex justify-center items-center flex-col gap-5">
      ...
      <m.a href="anjuman-Resume.pdf" className="text-[#FC6459] hover:text-dark border border-[#FC6459] hover:bg-[#FC6459] cursor-pointer font-medium rounded-lg text-lg px-5 py-2 text-center mr-2 mb-2  z-50 transition-all duration-150 ease-linear hover:scale-105  ">Résumé</m.a>
